...
const hint = new VText(scene, { text: '点击「运行演示」开始：DP 计算斐波那契 F[12]', x: 0, y: 290, z: 0, color: PALETTE.textGlow, scale: 0.85 });
...
function buildTable() {
  clearView();
  new VText(scene, { text: 'F', x: -360, y: 0, z: 0, color: CYAN, scale: 0.8 });
  for (let i = 0; i <= N; i++) {
