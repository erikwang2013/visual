...
function clearView() {
  ...
  edgeView.forEach(e => { scene.remove(e.tube); e.tube.geometry.dispose(); e.tube.material.dispose(); if (e.tube.cone) { scene.remove(e.tube.cone); e.tube.cone.geometry.dispose(); } });
