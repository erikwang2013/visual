...
const hint = new VText(scene, { text: '点击「运行演示」开始：NRU —— R/M 位分四类，先淘汰最便宜的类', x: 0, y: 300, z: 0, color: PALETTE.textGlow, scale: 0.85 });
...
panel.addButton('运行演示', () => engine.start(runNRU()));
