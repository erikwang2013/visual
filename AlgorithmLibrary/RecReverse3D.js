...
const S0 = 'ABCDE';
const N = S0.length;
const inChips = S0.split('').map((ch, i) => new VBox(scene, { w: 100, h: 50, d: 50, x: -264 + i * 132, y: 190, z: 0, label: ch, color: BLUE, emissive: BLUE }));
...
const outChips = Array.from({ length: N }, (_, i) => new VBox(scene, { w: 100, h: 50, d: 50, x: -264 + i * 132, y: -190, z: 0, label: '?', color: DIM, emissive: DIM }));
