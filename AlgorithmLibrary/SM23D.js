...
const hint = new VText(scene, { text: '点击「运行演示」开始：SM2 签名 —— toy 曲线上的国密签名与验签', x: 0, y: 300, z: 0, color: PALETTE.textGlow, scale: 0.85 });
...
panel.addButton('运行演示', () => engine.start(runSM2()));
panel.addButton('清空', () => {
  engine.clear();
