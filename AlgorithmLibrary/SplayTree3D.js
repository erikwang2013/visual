...
const hint = new VText(scene, { text: '点击「运行演示」开始：Splay 伸展到根（zig/zig-zig/zig-zag）', x: 0, y: 300, z: 0, color: PALETTE.textGlow, scale: 0.8 });
...
panel.addButton('运行演示', () => engine.start(runSplay()));
