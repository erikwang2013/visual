...
基于 three.js 的算法可视化网站：**125 个数据结构与算法**，每个算法都有可交互的 3D 动画演示、逐步执行与文字讲解。

## 特性

- **125 个算法页面**：线性结构、树、堆、图、排序、查找、哈希、动态规划、字符串匹配、网络流、密码学、压缩、机器学习、分布式、量子算法等
...
```
visual/
├── index.html                  # 首页目录（125 个算法入口 + 搜索 + 浮动导航）
